...
namespace NursingPracticals.Migrations
{
    ...
    [Migration("20241016183037_TaskGroupsSeed")]
    partial class TaskGroupsSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NursingPracticals.Models.Steps", b =>
                {
                    ...
                    b.Property<short?>("ComponentTasksID1")
                        .HasColumnType("smallint")
                        .HasColumnName("componenttasksid1");
            ...
            modelBuilder.Entity("NursingPracticals.Models.Steps", b =>
                {
                    b.HasOne("NursingPracticals.Models.ComponentTasks", "ComponentTasks")
                        .WithMany("Steps")
                        .HasForeignKey("ComponentTasksID1")
                        .HasConstraintName("fk_steps_componenttasks_componenttasksid1");
