...
namespace NursingPracticals.Migrations
{
    ...
    [Migration("20241016163719_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComponentTasksSteps", b =>
                {
                    ...
                    b.HasKey("ComponentTasksID", "StepsID")
                        .HasName("pk_componenttaskssteps");

                    b.HasIndex("StepsID");

                    b.ToTable("componenttaskssteps", (string)null);
                });
            ...
            modelBuilder.Entity("NursingPracticals.Models.ClassSchedules", b =>
                {
                    ...
                    b.Property<string>("ComponentTasksID")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("componenttasksid");
            ...
            modelBuilder.Entity("NursingPracticals.Models.Results", b =>
                {
            ...
            modelBuilder.Entity("NursingPracticals.Models.Steps", b =>
                {
                    ...
                    b.Property<int>("ComponentTasksID")
                        .HasColumnType("integer")
                        .HasColumnName("componenttasksid");
            ...
            modelBuilder.Entity("ComponentTasksSteps", b =>
                {
                    b.HasOne("NursingPracticals.Models.ComponentTasks", null)
                        .WithMany()
                        .HasForeignKey("ComponentTasksID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_componenttaskssteps_componenttasks_componenttasksid");

                    b.HasOne("NursingPracticals.Models.Steps", null)
                        .WithMany()
                        .HasForeignKey("StepsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_componenttaskssteps_steps_stepsid");
                });
            ...
            modelBuilder.Entity("NursingPracticals.Models.Results", b =>
                {
                    b.HasOne("NursingPracticals.Models.Students", null)
                        .WithMany("Results")
                        .HasForeignKey("StudentsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_results_students_studentsid");
                });
